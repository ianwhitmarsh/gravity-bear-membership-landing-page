# Choose GRAVITY BEAR Landing Page

Static landing page for GRAVITY BEAR adult membership and $19 first-month ads in Tulsa. The page uses hosted GRAVITY BEAR images so it can deploy from a tiny static repo.

Open `index.html` in a browser to view the page, or run:
